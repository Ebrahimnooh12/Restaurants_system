...
if(isset($cop))
{
    if($cop!=NULL && $code!=NULL && $exp!=NULL && $val!=NULL)
    {
        $coupons=json_decode(file_get_contents('coupon.txt'), true);
        $in=count($coupons);
        $coupons[$in]["name"]=$cop;
        $coupons[$in]["code"]=$code;
        $coupons[$in]["exp"]=$exp;
        $coupons[$in]["val"]=$val;
    
        $file = fopen("coupon.txt","w");
        fwrite($file, json_encode( $coupons, JSON_PRETTY_PRINT));
        fclose($file);
        echo '<script>alert("the coupon has been added ");</script>';
    }
    else
    {
        echo '<script>alert("Cant add the coupon ! ");</script>';
    }
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12 d-flex">
                <div class="ee-register">    
                    ...
                    <form method='post'>
                        <div class="row">
                            <div class="col-12 mb-30"><h4><b>Coupon Name :</b></h4><input name='cop' placeholder='Coupon Name'></div>
                            <div class="col-12 mb-30"><h4><b>Coupon Code :</b></h4><input name='code' placeholder='Coupon code'></div>
                            <div class="col-12 mb-30"><h4><b>Value :</b></h4><input type='number' min="0" max="100" maxlength="3" name='val' placeholder='Enter value as %'></div> 
                            <div class="col-12 mb-30"><h4><b>Expire :</b></h4><input type='date' name='exp' min="<?php echo date("Y-m-d"); ?>" placeholder='Enter Expire date'></div>                            
                            <div class="col-12 ml-150"><input  id='sub' type="submit" value="ADD" name='addC'></div>   
                    </form>
                </div>
            </div>
    </div>
